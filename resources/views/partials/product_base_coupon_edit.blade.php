            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <select name="product_ids[]" class="form-control product_id demo-select2" required>
                        @foreach(\App\ViewProduct::where('sub_category_id', $details->subcategory_id)->get() as $key => $product)
...
<div class="text-right">
    <button class="btn btn-primary" type="button" name="button" style="margin-bottom: 10px;" onclick="appendNewProductChoose()">{{ __('Add More') }}</button>
</div>
<div class="form-group">
...
<script type="text/javascript">
    ...
    function prependNewProductChoose(el){
        $(el).parent().next().hide('slow', function(){
