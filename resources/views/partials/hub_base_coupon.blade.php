<div class="panel-heading">
    <h3 class="panel-title">{{__('Add Your Hub Base Coupon')}}</h3>
</div>
<div class="form-group">
    <label class="col-lg-3 control-label" for="coupon_code">{{__('Coupon code')}}</label>
    <div class="col-lg-9">
        <input type="text" placeholder="{{__('Coupon code')}}" id="coupon_code" name="coupon_code" class="form-control"
            required>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-lg-9">
        <input type="number" min="0" step="0.01" placeholder="{{__('Maximum Discount Amount')}}" name="max_discount"
            class="form-control" required>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="number" min="0" step="1" placeholder="{{__('Quantity')}}" name="coupon_quantity"
            class="form-control" required>
...
<div class="form-group">
    ...
    <div class="col-lg-9">
        <div class="checkbox">
            <label><input type="checkbox" name="hubs[]" value="1">Manila</label>
        </div>
        <div class="checkbox">
            <label><input type="checkbox" name="hubs[]" value="2">Cebu</label>
        </div>
        <div class="checkbox">
            <label><input type="checkbox" name="hubs[]" value="3">Davao</label>
        </div>
        <div class="checkbox">
            <label><input type="checkbox" name="hubs[]" value="5">Rest Of Phil</label>
        </div>
    </div>
</div>
