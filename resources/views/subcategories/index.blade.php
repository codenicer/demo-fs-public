                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a href='{{route('subcategories.destroy', $subcategory->id)}}' onclick="return confirm('All products that assigned in this sub category will also be deleted. Do you want to continue?');">{{__('Delete')}}</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
