<div class="panel">
    ...
    <!--Horizontal Form-->
    <!--===================================================-->
    <form class="form-horizontal" action="{{ route('home_categories.update', ['id' => $homeCategory->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <div class="panel-body">
            <div class="form-group" id="category">
                ...
                <div class="col-lg-7">
                    <select class="form-control demo-select2-placeholder" name="category_id" id="collection_id" required>
            ...
            <div class="form-group" id="subsubcategory">
                ...
                <div class="col-lg-7">
                    <input type="number" value="{{$homeCategory->page_size}}" name="page_size" class="form-control demo-select2-placeholder">
                    </select>
                </div>
            </div>
        </div>
