...
<div class="col-sm-12">
    <div class="panel">
        ...
        <!--Horizontal Form-->
        <!--===================================================-->
        <form class="form-horizontal" action="{{ route('campaigns.store') }}" method="POST" enctype="multipart/form-data">
        	@csrf
            <div class="panel-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="page_size" required class="form-control demo-select2-placeholder">
