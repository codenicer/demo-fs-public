            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    {{-- <li class="{{ areActiveRoutes(['addons.index'])}}">
                                        <a class="nav-link" href="{{route('addons.index')}}">{{__('Addons')}}</a>
                                    ...
                                    --}}
                                    <li class="{{ areActiveRoutes(['product_types.index'])}}">
                                        <a class="nav-link" href="{{route('product_types.index')}}">{{__('Product Types')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="{{ areActiveRoutes(['collections.index', 'collections.create', 'collections.edit'])}}">
                                <a class="nav-link" href="{{ route('collections.index') }}">
                                    <i class="fa fa-cloud"></i>
                                    <span class="menu-title">{{__('Collections')}}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="{{ areActiveRoutes(['collections.index', 'collections.create', 'collections.edit'])}}">
                                <a class="nav-link" href="{{ route('popups.index') }}">
                                    ...
                                    <span class="menu-title">{{__('Pop Ups')}}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        <li>
                            <a href="{{route('page.construction')}}">
                                <i class="fa fa-user-plus"></i>
                            ...
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['customers.index'])}}">
                                    <a class="nav-link" href="{{route('page.construction')}}">{{__('Customer list')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                        ...
                        <li class="{{ areActiveRoutes(['support_ticket.admin_index', 'support_ticket.admin_show'])}}">
                            <a class="nav-link" href="{{route('page.construction')}}">
