    ...
    <div class="col-md-6">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">Total Collections</p>
                        <p class="text-semibold text-3x text-main">{{ \App\Collection::all()->count() }}</p>
                        <a href="{{ route('collections.create') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">Create Collection</a>
                    </div>
                </div>
                <div class="panel">
                    <div class="pad-top text-center dash-widget">
                        <p class="text-normal text-main">Total Active Campaigns</p>
                        <p class="text-semibold text-3x text-main">{{ \App\CampaignSchedule::where('is_active',1)->count() }}</p>
{{--                        <a href="{{ route('brands.index') }}" class="btn btn-primary mar-top btn-block top-border-radius-no">View Campaigns</a>--}}
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach (\App\Category::all() as $key => $category)
                                <tr>
                                    ...
                                    <td>{{ (new \App\Product)->categories()->where('category_id',$category->category_id)->count() }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
