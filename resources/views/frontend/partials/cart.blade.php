                ...
                @if(count($cart = Session::get('cart')) >= 1)
                            ...
                            <div class="dc-item">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="dc-content">
                                        ...
                                        <span class="dc-price">{{ single_price($cartItem['price']*abs($cartItem['quantity'])) }}</span>
                                    </div>
                                    <div class="dc-actions">
                                        <button onclick="removeFromCartView(event, {{ $key }})">
                    ...
                    <div class="py-2 text-center dc-btn">
                        <ul class="inline-links inline-links--style-3">
                            ...
                            {{--<li>--}}
                                {{--<a href="{{ route('checkout.shipping_info') }}" class="link link--style-1 text-capitalize btn btn-base-1 px-3 py-1 light-text hov-bounce hov-shaddow">--}}
