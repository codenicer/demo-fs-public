                ...
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-8">
                        <form class="form-default" data-toggle="validator"
                              action="{{ route('checkout.payment_select', ['id' => $user->id ]) }}" role="form" method="POST">
                            @csrf
                            <div class="card">
                                @if(Auth::check())
                                    @php
                                        ...
                                        <div class="border p-3">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-3 text-center">
                                                   <a href="{{route('checkout.edit_confirm_info', ['id' => $user->id])}}">
                                                       <button type="button" class="btn btn-outline-info mr-auto">Change</button></a>
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-6 col-sm-4 col-md-4 text-right">
                                    <button type="submit" class="btn btn-styled btn-base-1 w-100" id="submit_button"
