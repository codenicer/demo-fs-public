                                        ...
                                        <div class="product-card-2 card card-product mx-3 my-5 shop-cards shop-tech">
                                            <div class="card-body p-0">
                                                ...
                                                <div class="card-image">
                                                    <a href="{{ route('product', urlencode($product->handle)) }}" class="d-block" style="background-image:url('{{ asset($product->featured_img) }}');">
                                                    </a>
                                                </div>
                                                ...
                                                <div class="p-3">
                                                    ...
                                                    <h2 class="product-title p-0 text-truncate-2">
                                                        <a href="{{ route('product', urlencode($product->handle))  }}">{{ __($product->name) }}</a>
                                                    </h2>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @foreach ($products as $key => $product)
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="card product-box-1 mb-3">
                                    <div class="card-image">
                                        <a href="{{ route('product', urlencode($product->handle)) }}" class="d-block" style="background-image:url('{{ asset($product->thumbnail_img) }}');" tabindex="0">
                                        </a>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="px-3 py-2">
