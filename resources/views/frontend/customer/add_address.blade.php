            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('addAddress') }}">{{__('Add New Address')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="" action="{{ route('add.new.address') }}" method="POST" enctype="multipart/form-data">
                            @if ($errors->any())
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row address-choose">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <textarea class="form-control textarea-autogrow mb-3" placeholder="Apartment,suite,etc.(optional)" rows="1" name="address2" required></textarea>
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker province_id" id="province" data-placeholder="Select your province" name="province">
                                                    <option value="" selected disabled hidden>Select Address</option>

                                                @foreach($provinces as $key => $province)
                                                        <option value="{{ ucwords(strtolower($province->provDesc)) }}">{{ ucfirst(strtolower($province->provDesc)) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker city_id" id="city" data-placeholder="Select your city" name="city">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker brgy_id" id="baranggay" data-placeholder="Select your brgy" name="brgy" required>
...
g
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Enter Postal Code" name="postal_code" value="" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Enter Phone Number" name="phone" value="" required>
                                        </div>
                                    </div>
