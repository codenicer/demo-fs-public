                ...
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-8">
                        <form class="form-default" data-toggle="validator"
                              action="{{ route('checkout.update_confirm_info', ['id' => $user->id]) }}" role="form" method="POST">
                            @method('patch')
                            @csrf
                            <div class="card">
                                @if(Auth::check())
                                ...
                                @else
                                    <div class="card-body">
                                        <div class="row">
                                            <img src="https://s3-eu-west-1.amazonaws.com/tpd/logos/5b34c5b64b79dd00013d7fa3/0x0.png"
                                                 class="w-100">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h6 class="text-center text-warning">4.9 <i class="fa fa-star"></i> <i
                                                            class="fa fa-star"></i>
                                                    <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                            class="fa fa-star"></i> <span class="text-info">Based On Google</span>
                                                </h6>
                                                ...
                                                <div class="container">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" value="{{$user->email}}"
                                                               id="email_address" name="email_address" aria-describedby="emailHelp"
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="first_name" name="first_name"
                                                       placeholder="First Name" value="{{$shipping_address->first_name}}">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="container">
                                            <div class="row mt-2">
                                                <input type="text" class="form-control mb-2" id="address1" value="{{$shipping_address->address_1}}"
                                                       name="address1" placeholder="Address">
                                                <input type="text" class="form-control mb-2" id="address2" value="{{$shipping_address->address_2}}"
                                                       name="address2" placeholder="Apartment,suite,etc.(optional">
                                                <input type="text" class="form-control mb-2" id='city' name="city" value="{{$shipping_address->city}}"
                                                       placeholder="City">
                                                <input type="text" class="form-control mb-2" id='province' name="province" value="{{$shipping_address->province}}"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{$shipping_address->zip}}"
                                        ...
                                        <div class="container">
                                            <div class="row mt-2">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Phone" name="phone" id="phone" value="{{$shipping_address->phone}}"
