	...
	<div style="background: #eceff4;padding: 1.5rem;">
		<table>
			<tr>
				<td>
					...
					@else
						<img class="flowerstore-logo" src="{{ asset('frontend/images/logo/fsdesktoplogo.sgv') }}" height="40" style="display:inline-block;">
					@endif
				</td>
		...
		<table>
			...
			<tr>
				...
				<td class="text-right small"><span class="gry-color small">Order Number:</span> <span class="strong">{{ $order->shopify_order_name }}</span></td>
			</tr>
			<tr>
				<td class="gry-color small">Phone: {{ $generalsetting->phone }}</td>
				<td class="text-right small"><span class="gry-color small">Order Date:</span> <span class=" strong">{{ date('d-m-Y', $order->created_at) }}</span></td>
			</tr>
		</table>
