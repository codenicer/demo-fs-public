    ...
    <div class="col-sm-12">
        ...
        @section('script')
            ...
            <script>
              ...
              var $sortableSlider = $("#categorylist");
              $sortableSlider.sortable({
                stop: function(event, ui){
                  var parameters = $sortableSlider.sortable('toArray');
                  var decrypt = {{$decrypt_id}}
                  console.log(parameters);
                  $.post('{{ route("categories.product_priorities") }}',{_token:'{{ csrf_token() }}',value:parameters,cat_id:decrypt} ,function(result){
                    if(result == 1){
