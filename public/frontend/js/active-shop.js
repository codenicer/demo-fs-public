            ...
            try{
                $this.flatpickr({
                   ...
                   // noCalendar: $this.data('datepicker-no-calendar') ? $this.data('datepicker-no-calendar') : false,
                    enableTime: false,//$this.data('datepicker-enable-time') ? $this.data('datepicker-enable-time') : false,
                    allowInput: false,//$this.data('datepicker-allow-input') ? $this.data('datepicker-allow-input') : true,
                    mode: 'single',//$this.data('datepicker-mode') ? $this.data('datepicker-mode') : 'single',
                    static: true,
                    inline: true,// $this.data('datepicker-inline') ? $this.data('datepicker-inline') : false,
                    nextArrow: '<i class="ion-ios-arrow-right" />',
                    prevArrow: '<i class="ion-ios-arrow-left" />'
                });
            }catch(error){
                console.log('Unable to load flatpickr');
            }
        ...
        $('.countdown').each(function() {
            ...
            $this.countdown(date).on('update.countdown', function(event) {
                var $this = $(this).html(event.strftime('' +
                    '<div class="countdown-item"><span class="countdown-digit">%I</span></div><span class="countdown-separator">:</span>' +
